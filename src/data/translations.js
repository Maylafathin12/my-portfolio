export const translations = {
  en: {
    ...
    skills: {
      ...
      groups: [
        { category: 'Core Frontend', color: '#e8c8ff', skills: ['React 19', 'Vite', 'TypeScript', 'JavaScript ES6+', 'HTML5', 'CSS3', 'Tailwind CSS', 'Tailwind CSS v4'] },
        { category: 'Creative & Motion', color: '#f9b8d4', skills: ['Three.js', 'GSAP', 'Framer Motion', 'Canvas 2D'] },
        { category: 'Backend & Data', color: '#b8f5e8', skills: ['Supabase', 'SQL', 'REST API', 'Real-time Data Integration', 'pg_cron', 'Web Crypto API'] },
        { category: 'Deployment', color: '#f9e0d9', skills: ['Vercel', 'Cloudflare', 'Git', 'GitHub'] },
        { category: 'Runtime & Tools', color: '#b8f5b0', skills: ['Bun', 'Figma', 'WordPress', 'Laravel', 'PHP', 'Browser APIs (Document PiP, Canvas API, Web Crypto API)', 'PWA (vite-plugin-pwa)'] },
        { category: 'Design', color: '#c8b4ff', skills: ['UI/UX Design', 'Design Systems', 'Responsive Design', 'Prototyping'] },
        { category: 'QA & Engineering', color: '#ffd6a5', skills: ['Manual Testing', 'Component-Driven Development', 'Web Performance Optimization', 'SOLID Principles', 'Vitest', 'Oxlint'] },
  ...
  id: {
    ...
    skills: {
      ...
      groups: [
        { category: 'Frontend Inti', color: '#e8c8ff', skills: ['React 19', 'Vite', 'TypeScript', 'JavaScript ES6+', 'HTML5', 'CSS3', 'Tailwind CSS', 'Tailwind CSS v4'] },
        { category: 'Kreatif & Animasi', color: '#f9b8d4', skills: ['Three.js', 'GSAP', 'Framer Motion', 'Canvas 2D'] },
        { category: 'Backend & Data', color: '#b8f5e8', skills: ['Supabase', 'SQL', 'REST API', 'Integrasi Data Real-time', 'pg_cron', 'Web Crypto API'] },
        { category: 'Deployment', color: '#f9e0d9', skills: ['Vercel', 'Cloudflare', 'Git', 'GitHub'] },
        { category: 'Runtime & Alat', color: '#b8f5b0', skills: ['Bun', 'Figma', 'WordPress', 'Laravel', 'PHP', 'Browser APIs (Document PiP, Canvas API, Web Crypto API)', 'PWA (vite-plugin-pwa)'] },
        { category: 'Desain', color: '#c8b4ff', skills: ['Desain UI/UX', 'Design Systems', 'Desain Responsif', 'Prototyping'] },
        { category: 'QA & Rekayasa', color: '#ffd6a5', skills: ['Manual Testing', 'Component-Driven Development', 'Optimasi Performa Web', 'Prinsip SOLID', 'Vitest', 'Oxlint'] },
